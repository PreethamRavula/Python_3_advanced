...
# Add your code below!
number_of_moves = Counter(move[0] for move in robot_moves)
...
# Add your code below!
for bot in bots:
  bot_scores.append([BotScoreData(bot.name, number_of_moves, collision_count, number_of_moves + collision_count)])
...
while len(robot_moves) > 0:
  ...
  # Add your code below!
  bot_name, direction, collision = robot_moves.popleft()
